...
```shell
uv pip install --system -v -e .  # Install the minimal requirements of Data-Juicer
uv pip install --system -v -e ".[dist]"  # Include dependencies on Ray and other distributed libraries
```
