    ...
    .. tab-item:: AWS
        ...
        .. code-block:: yaml
            ...
            setup_commands:
              ...
              - uv pip install --system -U https://s3-us-west-2.amazonaws.com/ray-wheels/latest/ray-3.0.0.dev0-cp37-cp37m-manylinux2014_x86_64.whl
...
- Setup commands are run sequentially but separately. For example, if you are using anaconda, you need to run ``conda activate env && uv pip install --system -U ray`` because splitting the command into two setup commands will not work.
