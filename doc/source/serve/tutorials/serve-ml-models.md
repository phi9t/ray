...
```console
$ uv pip install --system "tensorflow>=2.0" requests "ray[serve]"
```
...
```console
$ uv pip install --system torch torchvision requests  "ray[serve]"
```
...
```console
$ uv pip install --system scikit-learn requests "ray[serve]"
```
